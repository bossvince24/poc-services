...
public class BookServiceImpl implements BookService {
	...
	@Override
	public Book updateBookDetails(Book book, Long id, Long authorId) throws BookNotFoundException {
		// TODO Auto-generated method stub
		...
		if (authorId != null) {
			Author newAuthor = authorRepository.findById(authorId)
					.orElseThrow(() -> new BookNotFoundException("Author with ID " + authorId + " not found"));
